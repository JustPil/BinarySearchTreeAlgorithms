...
public class ArrayListQueue<T> implements QueueInterface<T>
{
     ...
     * @throws EmptyQueueDequeue If dequeue is attempted while the ArrayList is empty.
     */
    public T dequeue() throws EmptyQueueDequeue
    {
        if(isEmpty())
            throw new EmptyQueueDequeue("dequeue attempted on an empty queue.");
